...
function updateSystemHealth() {
  ...
  elements.sidebarApiStatus.innerHTML = `<i class="${apiKeyState.isConnected ? "is-ok" : ""}" aria-hidden="true"></i>${apiKeyState.isConnected ? "API verbunden" : apiKeyState.value ? "API gespeichert" : "API fehlt"}`;
  elements.sidebarStorageStatus.innerHTML = `<i class="is-ok" aria-hidden="true"></i>Browser-Speicher`;
